...
class PulseScr(Screen):
    def __init__ (self, **kwargs):
        ...
        self.lbl_self.bind(done = self.sec_finished)
...
class CheckSits(Screen):
    def __init__ (self, **kwargs):
        ...
        line = BoxLayout()
        vlay = BoxLayout(orientatoin = "vertical", size_hint = (0.3,1))
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        line1.add_widget(self.in_resut1)

        line2 = BoxLayout(size_hint = (0.8, None), height = "30sp")
        Ibl_result2 = Label(text = "Результат після відпочинку:", halign = 'right')
        self.in_result2 = TextInput(text =  "0", multiline = False)
                                    
        self.in_resultl.set_disabled(True)
        self.inresult.set.disabled(True)